...
export class AuthController {
  ...
  @Post('otp/verify')
  async verifyOtp(@Body('phone') phone: string, @Body('code') code: string, @Res({ passthrough: true }) res: any) {
  ...
  @Post('verify-otp')
  verifyOtpAlias(@Body('phone') phone: string, @Body('code') code: string, @Res({ passthrough: true }) res: any) {
