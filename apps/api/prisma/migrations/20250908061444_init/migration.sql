...
CREATE TABLE "ProductVariantAddon" (
    ...
    CONSTRAINT "ProductVariantAddon_pkey" PRIMARY KEY ("variantId","addonId")
);
...
CREATE TABLE "DeliverySlot" (
    ...
    "city" TEXT NOT NULL DEFAULT 'al-ain',
...
-- CreateIndex
CREATE UNIQUE INDEX "DeliverySlot_city_start_end_key" ON "DeliverySlot"("city", "start", "end");
...
-- AddForeignKey
ALTER TABLE "ProductVariantAddon" ADD CONSTRAINT "ProductVariantAddon_addonId_fkey" FOREIGN KEY ("addonId") REFERENCES "Addon"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
